...
enum Sample {
    ...
    static let events: [PEvent] = [
        PEvent(id: "e1", start: date(inDays: 2, at: 14), title: "Five-a-side", time: "2:00–4:00 PM",
               ...
               badge: "Found", badgeTone: .free, source: .plannit, sharedGroupIds: ["soccer"]),
    ...
    static let activity: [PActivity] = [
        ...
        PActivity(id: "a5", kind: .declined, happenedAt: Date().addingTimeInterval(-3600),
                  actor: "Sam Roe", title: "Five-a-side", subtitle: nil,
                  eventId: "e1", groupId: "soccer"),
